...
function Footer() {
  return (
    <footer>
      <div className="pl-[8.5%] pr-[3%] pt-[8.5%] text-[0.94rem] xl:text-[1.2rem]">
        <header className="mb-7">
          <div>
            <p className="text-[2.4rem] xl:text-[3.84rem] font-medium">
              Ableton
            </p>
          </div>
        </header>
        ...
        <div></div>
        <div className="text-[0.83rem] space-y-1.5">
          <div>
            <a href="/" className="inline-block">
              <p>Contact Us</p>
            </a>
